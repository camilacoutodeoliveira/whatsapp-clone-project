    ...
    initEvents() {
        ...
        this.el.inputDocument.on('change', e => {
            if (this.el.inputDocument.files.length) {
                ...
                this._documentPreviewController.getPreviewData(file).then(result => {
                    console.log('ok', result);
                    this.el.imgPanelDocumentPreview.src = result.src;
                    this.el.infoPanelDocumentPreview.src = result.info;
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji => {
            emoji.on('click', e => {
                ...
                //getselection identifica onde o cursor está
                let cursor = window.getSelection();
                if (!cursor.focusNode || cursor.focusNode.id == 'input-text') {
                    this.el.inputText.focus();
                    cursor = window.getSelection();
                }
                //range de valores, identifica a posição, intervalo de seleção
                ...
                //força para que determinado event aconteça
